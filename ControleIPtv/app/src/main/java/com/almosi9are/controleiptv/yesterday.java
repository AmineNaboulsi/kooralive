...
public class yesterday extends Fragment implements match_click{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("yesterday");
        View view = inflater.inflate(R.layout.fragment_yesterday, null);

        rec_today = view.findViewById(R.id.rec_yesterday);
                    ...
                    for(DocumentSnapshot item :d){
                        ...
                        try {
                            ...
                            calendarTomorrow.add(Calendar.DAY_OF_YEAR, 1);
                             ...
                             if (isYesterday(calendarFirestore, calendarToday)) {
