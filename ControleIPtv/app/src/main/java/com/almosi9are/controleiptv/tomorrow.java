...
public class tomorrow extends Fragment implements match_click{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("tomorrow");
        View view = inflater.inflate(R.layout.fragment_tomorrow, null);

        rec_today = view.findViewById(R.id.rec_tomorrow);
                ...
                if(!d.isEmpty()){
                    ...
                    for(DocumentSnapshot item :d){
                        ...
                        try {
                            ...
                            if (isTomorrow(calendarFirestore, calendarToday)) {
